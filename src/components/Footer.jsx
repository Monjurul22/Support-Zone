      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-sm text-slate-400 leading-relaxed mb-5 max-w-xs">
            Streamline your customer support workflow. Track, manage, and
            resolve tickets with ease and confidence.
          </p>
          <div className="flex items-center gap-3">
            {socialIcons.map((Icon, i) => (
              <a
                key={i}
                href="#"
                className="w-9 h-9 rounded-lg bg-slate-800 hover:bg-indigo-600 flex items-center justify-center text-slate-400 hover:text-white transition-all"
              >
        ...
        <div>
          ...
          <ul className="space-y-2.5">
            {["Help Center", "FAQ", "Documentation", "API Reference"].map(
              (link) => (
                <li key={link}>
                  <a
                    href="#"
